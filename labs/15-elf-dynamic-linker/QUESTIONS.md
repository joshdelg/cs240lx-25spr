...
# 2-my-dynamic-linker
How does JMPREL differ from the other REL/RELA sections? Why is this the one we use? What does "solely involved with procedure linkage" mean?

What exactly does "position-independent code" mean?