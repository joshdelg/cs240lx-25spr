...
enum {
    ...
    DEBUGBASE = 0x50000, // where debug target gets linked.
    ...
    // @joshdelg Additional symbols for debugger
    GET_DEBUG_INFO  = 0x99990000,       // pi sends
    PUT_DEBUG_INFO  = 0x99991111,       // unix sends

    GET_DEBUG_CODE  = 0x99992222,       // pi sends
    PUT_DEBUG_CODE  = 0x99993333,       // unix sends
...
static inline const char *boot_op_to_str(unsigned op) {
    ...
    // @joshdelg Additional symbols for debugger
    case GET_DEBUG_INFO: return "GET_DEBUG_INFO";
    case PUT_DEBUG_INFO: return "PUT_DEBUG_INFO";
    case GET_DEBUG_CODE: return "GET_DEBUG_CODE";
    case PUT_DEBUG_CODE: return "PUT_DEBUG_CODE";
